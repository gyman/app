...
use Gyman\Bundle\AppBundle\Validator as DefaultBundle;
 ...
 *      "single" = "Gyman\Bundle\ScheduleBundle\Entity\Single",
 *      "weekly" = "Gyman\Bundle\ScheduleBundle\Entity\Weekly",
 * })
 * @codeCoverageIgnore
 */
abstract class Event
{
    ...
    /**
     * Gyman\Bundle\ScheduleBundle\Validator\RequiredIfNoNewActivity
     * @JMS\Exclude
     * @ORM\ManyToOne(targetEntity="Gyman\Bundle\ScheduleBundle\Entity\Activity", inversedBy="events",cascade={"persist"})
     * @Assert\NotBlank(
     *  groups={"dbActivity"}
     * )
    ...
    /**
     * @JMS\Exclude
     * @ORM\OneToMany(targetEntity="Gyman\Bundle\ScheduleBundle\Entity\Occurrence", mappedBy="event",cascade={"persist", "remove"}, orphanRemoval=true)
     */
