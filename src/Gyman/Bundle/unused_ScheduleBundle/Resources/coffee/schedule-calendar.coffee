$ ->
  ...
  $('#calendar').fullCalendar
    ...
    eventClick: (event, element) ->
      window.modal.showFromUrl Routing.generate("_events_edit", {occurrence : event.occurrence_id})

    # event.title = "CLICKED!";
    # $('#calendar').fullCalendar('updateEvent', event);
      
#    eventDrop: (event, dayDelta, minuteDelta, allDay, revertFunc, jsEvent, ui, view) ->
#      url = Routing.generate('_events_drag', {occurrence: event.id})
#      params =
#        delta:
#          days: dayDelta
#          minutes: minuteDelta
...
#      url = Routing.generate('_events_resize', {occurrence: event.id})
#      params =
