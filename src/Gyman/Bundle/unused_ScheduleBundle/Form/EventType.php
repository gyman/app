...
class EventType extends AbstractType
{
    ...
    public function setOccurrence(Events\Occurrence $occurrence)
    {
        ...
        return function (FormInterface $form) {
            ...
            if ($event->isNew()) {
                ...
                if ($form->getRoot()->has('editType')) {
                    ...
                    $editType = Events\Occurrence::SINGULAR;
                }

                $validationGroups[] = 'edit';

                if ($editType == Events\Occurrence::SERIAL) {
                    $validationGroups[] = 'serial';
                    $validationGroups[] = 'notSingle';
                } elseif ($editType == Events\Occurrence::SINGULAR) {
    ...
    private function isOccurrenceSerial()
    {
        return $this->getOccurrence() instanceof Events\Serial;
    }
    ...
    private function setupDescription(Form $form)
    {
        $form->add('description', 'textarea', [
            'label'  => 'Opis',
            'data'   => $this->getOccurrence()->getDescription(),
            'mapped' => false,
            'attr'   => [
    ...
    private function setupEditType(Form $form)
    {
        $form->add('editType', 'choice', [
            'choices'     => [
                Events\Occurrence::SERIAL   => 'to wystąpienie i wszystkie następne',
                Events\Occurrence::SINGULAR => 'tylko to wystąpienie',
            ],
            'empty_data'  => Events\Occurrence::SINGULAR,
            'mapped'      => false,
            'label'       => 'Edytuj',
            'expanded'    => true,
            'multiple'    => false,
