...
use Dende\ScheduleBundle\Validator\AtLeastOneDaySelectedIfNotSingle;
...
class EventType extends AbstractType {
    ...
    private function getValidationGroupsCallback() {
        return function(FormInterface $form) {
            ...
            /** @var Dende\ScheduleBundle\Entity\Event $entity */
            $event = $form->getData();
            ...
            if ($event->isNew())
            {
                ...
                else if ($eventType == Events\Event::SINGLE)
                {
            ...
            else
            {
                ...
                else if ($editType == Events\Occurence::SINGULAR)
                {
