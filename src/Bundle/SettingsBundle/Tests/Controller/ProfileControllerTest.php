<?php
namespace Gyman\Bundle\SettingsBundle\Tests\Controller;
...
class ProfileControllerTest extends BaseTest
{
    ...
    public function testUpdateProfileDb()
    {
        ...
        $user = $entityManager->createQuery("SELECT u FROM Gyman\Bundle\SettingsBundle\Entity\User u WHERE u.username = 'uirapuru'")->getResult();
