 ...
 */
class Version20171011220351 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE calendars DROP calendar_id, CHANGE id id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE entries CHANGE occurrence_id occurrence_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
        $this->addSql('ALTER TABLE users ADD member_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', ADD invitationToken VARCHAR(255) DEFAULT NULL, DROP locked, DROP expired, DROP expires_at, DROP credentials_expired, DROP credentials_expire_at, CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE username username VARCHAR(180) NOT NULL, CHANGE username_canonical username_canonical VARCHAR(180) NOT NULL, CHANGE email email VARCHAR(180) NOT NULL, CHANGE email_canonical email_canonical VARCHAR(180) NOT NULL, CHANGE salt salt VARCHAR(255) DEFAULT NULL, CHANGE confirmation_token confirmation_token VARCHAR(180) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE member_section CHANGE section_id section_id INT NOT NULL');
        $this->addSql('DROP INDEX UNIQ_2B9643982B36786B ON sections');
        $this->addSql('ALTER TABLE sections ADD deleted_at DATETIME DEFAULT NULL, ADD createdAt DATETIME DEFAULT NULL, ADD updatedAt DATETIME DEFAULT NULL, ADD orderNumber INT NOT NULL, ADD section_id VARCHAR(255) NOT NULL, CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE calendar_id calendar_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_2B964398D823E37A ON sections (section_id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE calendars ADD calendar_id VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, CHANGE id id CHAR(36) NOT NULL COLLATE utf8_unicode_ci COMMENT \'(DC2Type:guid)\'');
        $this->addSql('ALTER TABLE entries CHANGE occurrence_id occurrence_id CHAR(36) DEFAULT NULL COLLATE utf8_unicode_ci COMMENT \'(DC2Type:guid)\'');
        ...
        $this->addSql('ALTER TABLE member_section CHANGE section_id section_id CHAR(36) NOT NULL COLLATE utf8_unicode_ci COMMENT \'(DC2Type:guid)\'');
        ...
        $this->addSql('DROP INDEX UNIQ_2B964398D823E37A ON sections');
        $this->addSql('ALTER TABLE sections DROP deleted_at, DROP createdAt, DROP updatedAt, DROP orderNumber, DROP section_id, CHANGE id id CHAR(36) NOT NULL COLLATE utf8_unicode_ci COMMENT \'(DC2Type:guid)\', CHANGE calendar_id calendar_id CHAR(36) DEFAULT NULL COLLATE utf8_unicode_ci COMMENT \'(DC2Type:guid)\'');
