 ...
 */
class Version20171210223116 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE entries CHANGE id id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', CHANGE member_id member_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', CHANGE voucher_id voucher_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', CHANGE occurrence_id occurrence_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', CHANGE endDate endDate DATETIME DEFAULT NULL, CHANGE deletedAt deletedAt DATETIME DEFAULT NULL, CHANGE price_amount price_amount NUMERIC(10, 2) DEFAULT NULL, CHANGE price_currency price_currency VARCHAR(10) DEFAULT NULL');
        $this->addSql('ALTER TABLE members CHANGE current_voucher_id current_voucher_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', CHANGE last_entry_id last_entry_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', CHANGE nameSlug nameSlug VARCHAR(255) DEFAULT NULL, CHANGE deletedAt deletedAt DATETIME DEFAULT NULL, CHANGE createdAt createdAt DATETIME DEFAULT NULL, CHANGE updatedAt updatedAt DATETIME DEFAULT NULL, CHANGE birthdate birthdate DATE DEFAULT NULL, CHANGE phone phone VARCHAR(64) DEFAULT NULL, CHANGE zipcode zipcode VARCHAR(255) DEFAULT NULL, CHANGE gender gender VARCHAR(255) DEFAULT NULL, CHANGE starred starred TINYINT(1) DEFAULT NULL, CHANGE color color VARCHAR(255) DEFAULT NULL, CHANGE foto foto VARCHAR(255) DEFAULT NULL, CHANGE barcode barcode VARCHAR(64) DEFAULT NULL');
        $this->addSql('ALTER TABLE occurrences CHANGE event_id event_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', CHANGE instructor_id instructor_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', CHANGE duration_minutes duration_minutes INT DEFAULT NULL');
        $this->addSql('ALTER TABLE occurrences ADD CONSTRAINT FK_3F04912C8C4FC193 FOREIGN KEY (instructor_id) REFERENCES users (id)');
        $this->addSql('CREATE INDEX IDX_3F04912C8C4FC193 ON occurrences (instructor_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE occurrences DROP FOREIGN KEY FK_3F04912C8C4FC193');
        $this->addSql('DROP INDEX IDX_3F04912C8C4FC193 ON occurrences');
