...
namespace Proxies\__CG__\Gyman\Bundle\ClubBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Club extends \Gyman\Bundle\ClubBundle\Entity\Club implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'sections', 'subdomain', 'database', 'details'];
        }
     ...
     * {@inheritDoc}
     */
    public function setDetails(\Gyman\Bundle\ClubBundle\Entity\Details $details)
    {
