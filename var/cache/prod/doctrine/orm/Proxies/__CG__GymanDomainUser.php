 ...
 */
class User extends \Gyman\Domain\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Gyman\\Domain\\User' . "\0" . 'firstname', '' . "\0" . 'Gyman\\Domain\\User' . "\0" . 'lastname', '' . "\0" . 'Gyman\\Domain\\User' . "\0" . 'member', '' . "\0" . 'Gyman\\Domain\\User' . "\0" . 'invitationToken', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function setInvitationToken($token)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setInvitationToken', [$token]);

        return parent::setInvitationToken($token);
    }
    ...
    public function invitationToken(): string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'invitationToken', []);
