...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->fileMap = array(
            ...
            'gyman.app.twig.avatar' => __DIR__.'/getGyman_App_Twig_AvatarService.php',
            'gyman.app.twig.entries_extension' => __DIR__.'/getGyman_App_Twig_EntriesExtensionService.php',
            ...
            'gyman.twig.voucher_extension' => __DIR__.'/getGyman_Twig_VoucherExtensionService.php',
            ...
            'knp_menu.matcher' => __DIR__.'/getKnpMenu_MatcherService.php',
            'knp_menu.menu_provider' => __DIR__.'/getKnpMenu_MenuProviderService.php',
            ...
            'knp_menu.renderer_provider' => __DIR__.'/getKnpMenu_RendererProviderService.php',
            ...
            'time.datetime_formatter' => __DIR__.'/getTime_DatetimeFormatterService.php',
            'time.templating.helper.time' => __DIR__.'/getTime_Templating_Helper_TimeService.php',
...
protected function createProxy($class, \Closure $factory)
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $a->addEventSubscriber(${($_ = isset($this->services['doctrine.orm.listeners.resolve_target_entity']) ? $this->services['doctrine.orm.listeners.resolve_target_entity'] : $this->getDoctrine_Orm_Listeners_ResolveTargetEntityService()) && false ?: '_'});
        $a->addEventSubscriber(${($_ = isset($this->services['fos_user.user_listener']) ? $this->services['fos_user.user_listener'] : $this->getFosUser_UserListenerService()) && false ?: '_'});
        $a->addEventListener(array(0 => 'loadClassMetadata'), ${($_ = isset($this->services['dende_calendar.listener.doctrine_event_listener']) ? $this->services['dende_calendar.listener.doctrine_event_listener'] : $this->getDendeCalendar_Listener_DoctrineEventListenerService()) && false ?: '_'});
        $a->addEventListener(array(0 => 'loadClassMetadata'), ${($_ = isset($this->services['doctrine.orm.default_listeners.attach_entity_listeners']) ? $this->services['doctrine.orm.default_listeners.attach_entity_listeners'] : $this->services['doctrine.orm.default_listeners.attach_entity_listeners'] = new \Doctrine\ORM\Tools\AttachEntityListenersListener()) && false ?: '_'});

        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->getDoctrine_Dbal_ConnectionFactoryService()) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => 'gyman.vagrant', 'port' => 3306, 'dbname' => 'gyman', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'serverVersion' => '5.6', 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    protected function getDoctrine_Dbal_TenantConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.tenant_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->getDoctrine_Dbal_ConnectionFactoryService()) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => 'gyman.vagrant', 'port' => 3306, 'platform_service' => NULL, 'dbname' => NULL, 'user' => NULL, 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'wrapperClass' => 'Dende\\MultitenancyBundle\\Connection\\Wrapper', 'serverVersion' => '5.6', 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    {
        if ($lazyLoad) {
            return $this->services['doctrine.orm.default_entity_manager'] = $this->createProxy('EntityManager_81f2f48', function () {
                return \EntityManager_81f2f48::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
    ...
    {
        if ($lazyLoad) {
            return $this->services['doctrine.orm.tenant_entity_manager'] = $this->createProxy('EntityManager_48cada4', function () {
                return \EntityManager_48cada4::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8biOfMLnDb', 0, 'MdF-Q4lIPk4m5LLSo9CDDl', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'});
    }
    ...
    {
        return $this->services['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter('phpstorm://%f:%l');
    }
    ...
    {
        $this->services['dende_multitenancy.tenant_manager'] = $instance = new \Dende\MultitenancyBundle\Manager\TenantManager(${($_ = isset($this->services['event_dispatcher']) ? $this->services['event_dispatcher'] : $this->getEventDispatcherService()) && false ?: '_'});
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_99cc59cc59e3afd4e1445954f6e63dc70980a093764684b709acc53656bbcc44');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_TenantMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_tenant_99cc59cc59e3afd4e1445954f6e63dc70980a093764684b709acc53656bbcc44');
    ...
    {
        $this->services['monolog.handler.main'] = $instance = new \Monolog\Handler\FingersCrossedHandler(${($_ = isset($this->services['monolog.handler.grouped_main']) ? $this->services['monolog.handler.grouped_main'] : $this->getMonolog_Handler_GroupedMainService()) && false ?: '_'}, 400, 0, true, true, NULL);
    ...
    {
        $this->services['monolog.handler.streamed_main'] = $instance = new \Monolog\Handler\StreamHandler(($this->targetDirs[2].'/logs/prod.log'), 400, true, NULL);
        ...
        return array(
            ...
            'kernel.bundles_metadata' => array(
                ...
                'DendeCommonBundle' => array(
                    'parent' => NULL,
                    'path' => '/vagrant/vendor/dende/common-bundle/Dende/CommonBundle',
            ...
            'swiftmailer.spool.default.file.path' => '/vagrant/app/spool/default',
            ...
            'dende_multitenancy.config.patched_commands' => array(
                ...
                3 => 'gyman:vouchers:update_current',
            ),
