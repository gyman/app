...
protected function createProxy($class, \Closure $factory)
{
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('me7N6TLUaO', 0, 'S2duNi1Ib3EE1ueEnszFeb', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        if ($lazyLoad) {
            return $this->services['doctrine.orm.default_entity_manager'] = $this->createProxy('EntityManager_fdd9146', function () {
                return \EntityManager_fdd9146::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
    ...
    {
        if ($lazyLoad) {
            return $this->services['doctrine.orm.tenant_entity_manager'] = $this->createProxy('EntityManager_89a596b', function () {
                return \EntityManager_89a596b::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ljahnLTHei', 0, 'S2duNi1Ib3EE1ueEnszFeb', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('v5lNsSZ-oc', 0, 'S2duNi1Ib3EE1ueEnszFeb', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dTJYo1TdLx', 0, 'S2duNi1Ib3EE1ueEnszFeb', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => ($this->targetDirs[3].'/vendor/dende/calendar-bundle/Resources/config/validation.yml'), 1 => ($this->targetDirs[3].'/src/Bundle/AppBundle/Resources/config/validation/createClub.yml'), 2 => ($this->targetDirs[3].'/src/Bundle/AppBundle/Resources/config/validation/createMember.yml'), 3 => ($this->targetDirs[3].'/src/Bundle/AppBundle/Resources/config/validation/createVoucher.yml'), 4 => ($this->targetDirs[3].'/src/Bundle/AppBundle/Resources/config/validation/details.yml'), 5 => ($this->targetDirs[3].'/src/Bundle/AppBundle/Resources/config/validation/openEntryCommand.yml'), 6 => ($this->targetDirs[3].'/src/Bundle/AppBundle/Resources/config/validation/section.yml'), 7 => ($this->targetDirs[3].'/src/Bundle/AppBundle/Resources/config/validation/updateMember.yml'), 8 => ($this->targetDirs[3].'/src/Bundle/AppBundle/Resources/config/validation/updateSettings.yml'), 9 => ($this->targetDirs[3].'/src/Bundle/AppBundle/Resources/config/validation/updateVoucher.yml')));
