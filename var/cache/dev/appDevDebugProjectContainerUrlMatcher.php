...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/settings/settings')) {
            // gyman_settings
            if ('/settings/settings' === $trimmedPathinfo) {
            ...
            if ('/settings/settings/sections' === $pathinfo) {
            ...
            if ('/settings/settings/details' === $pathinfo) {
        ...
        // gyman_settings_sections_index
        if ('/settings/sections' === $pathinfo) {
            return array (  '_controller' => 'Gyman\\Bundle\\SettingsBundle\\Controller\\SectionsController::indexAction',  '_route' => 'gyman_settings_sections_index',);
        }
        ...
        elseif (0 === strpos($pathinfo, '/login')) {
            // gyman_app_login_after_registration
            if (0 === strpos($pathinfo, '/login-post-register') && preg_match('#^/login\\-post\\-register/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'gyman_app_login_after_registration')), array (  '_controller' => 'Gyman\\Bundle\\AppBundle\\Controller\\DefaultController::loginAfterRegistrationAction',));
            }
