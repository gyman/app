...
class Occurrence extends \Gyman\Domain\Calendar\Event\Occurrence implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'instructor', 'subject', 'note', 'entries', 'id', 'occurrenceData', 'modified', 'event'];
        }
     ...
     * {@inheritDoc}
     */
    public function instructor(): ?\Gyman\Domain\User
    {
     ...
     * {@inheritDoc}
     */
    public function subject(): \Gyman\Domain\Calendar\Event\Occurrence\Subject
    {
     ...
     * {@inheritDoc}
     */
    public function note(): \Gyman\Domain\Calendar\Event\Occurrence\Note
    {
     ...
     * {@inheritDoc}
     */
    public function setInstructor(\Gyman\Domain\User $user): void
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setInstructor', [$user]);

        parent::setInstructor($user);
    }
